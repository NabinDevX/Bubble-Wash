      ...
      try {
        ...
        if (!service) {
          ...
          setFormData({
            ...
            pricePerKg: service.pricePerKg || service.price || "",
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-on-surface-variant text-sm mt-1 ml-10">
          Update the pricing and details for this service category.
        </p>
      </div>
      ...
      <div className="glass-card rounded-2xl p-6 sm:p-8">
        ...
        {/* If error is "Service not found", we hide the form to avoid submitting bad data */}
