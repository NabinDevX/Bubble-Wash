...
export default function Settings() {
  ...
  async function handleChangePassword() {
    ...
    try {
      ...
      await api.post("/users/settings/change-password", {
        currentPassword,
        newPassword,
      });
  ...
  async function handleDeleteAccount() {
    ...
    try {
      await api.delete("/users/settings/delete-account");
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 space-y-5">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-3 items-start">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800">SMS Updates</p>
                <p className="text-xs text-gray-500">
